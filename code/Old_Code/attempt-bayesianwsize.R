...
# Test 3 -- Informative priors based on MTE!
...
model{
  ...
  #var3 <- 10 # what happens when you crank down the variance on the prior, such that all of the probability mass is right around -0.75? The result is that the data is still able to overwhelm the prior!!! 
  var3 ~ dgamma(2,1)
